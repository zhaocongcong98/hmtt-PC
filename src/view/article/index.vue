<template>
  <div>
    ...
    <el-button type="primary" icon="el-icon-edit" @click="toEdit(scope.row.id)" plain circle></el-button>
...
export default {
  ...
  methods: {
    ...
    // 获取文章列表数据
    async getArticles () {
      const { data: { data } } = await this.$http.get('articles', { params: this.reqParam })
